...
export const setBoardSettings = async (trelloContext: TrelloPowerUpContext, newSettings: Partial<BoardSettings>): Promise<void> => trelloContext.set(
  TrelloPowerUpDataScope.Board,
  TrelloPowerUpDataVisibility.Shared,
  BOARD_SETTINGS_KEY,
  {
    ...await getBoardSettings(trelloContext),
    ...newSettings,
  },
);